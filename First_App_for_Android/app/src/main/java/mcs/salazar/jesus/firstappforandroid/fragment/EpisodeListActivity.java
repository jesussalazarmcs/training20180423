package mcs.salazar.jesus.firstappforandroid.fragment;
...
import mcs.salazar.jesus.firstappforandroid.dummy.DummyContent;
...
public class EpisodeListActivity extends AppCompatActivity {
    ...
    public static Intent getIntent(Context context) {
        ...
        // Here add to intent whatever is required for this class.
        return intent;
    }
        ...
        private final View.OnClickListener mOnClickListener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mTwoPane) {
                    ...
                    arguments.putString(EpisodeDetailFragment.ARG_ITEM_ID, item.id);
                    ...
                    intent.putExtra(EpisodeDetailFragment.ARG_ITEM_ID, item.id);
